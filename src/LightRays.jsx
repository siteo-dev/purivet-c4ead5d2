...
const LightRays = ({
  ...
  useEffect(() => {
    ...
    observerRef.current = new IntersectionObserver(entries => { visibleRef.current = entries[0].isIntersecting }, { threshold: 0.01 })
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const loop = t => {
        ...
        if (!visibleRef.current) { animationIdRef.current = requestAnimationFrame(loop); return }
